"""
Geometric stiffness matrix for BFSC cylinder with Sanders-type kinematics
"""
import numpy as np
import sympy
...
def main():
    ...
    var('Nxx, Nyy, Nxy')
    Nmatrix = Matrix([[Nxx, Nxy, -Nxy],
                      [Nxy, Nyy, -Nyy],
                      [-Nxy, -Nyy, Nyy]])
    #NOTE adapted from https://doi.org/10.1016/j.compstruct.2014.07.037
    G = Matrix([
        (2/lex)*Nw.diff(xi),
        (2/ley)*Nw.diff(eta),
        1/R*Nv,
